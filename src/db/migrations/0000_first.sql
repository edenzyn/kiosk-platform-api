...
--> statement-breakpoint
CREATE TABLE "permissions_mapper" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
ALTER TABLE "permissions" ADD CONSTRAINT "permissions_branch_id_branches_id_fk" FOREIGN KEY ("branch_id") REFERENCES "public"."branches"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "permissions_mapper" ADD CONSTRAINT "permissions_mapper_permission_id_permissions_id_fk" FOREIGN KEY ("permission_id") REFERENCES "public"."permissions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "permissions_mapper" ADD CONSTRAINT "permissions_mapper_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
