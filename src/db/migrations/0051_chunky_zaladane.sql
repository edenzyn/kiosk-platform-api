...
ALTER TABLE "app_tax_components" ADD CONSTRAINT "app_tax_components_tax_rule_id_app_tax_rules_id_fk" FOREIGN KEY ("tax_rule_id") REFERENCES "public"."app_tax_rules"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "app_tax_rules" ADD CONSTRAINT "app_tax_rules_tax_profile_id_app_tax_profiles_id_fk" FOREIGN KEY ("tax_profile_id") REFERENCES "public"."app_tax_profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "app_tax_rules" ADD CONSTRAINT "app_tax_rules_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "app_tax_rules" ADD CONSTRAINT "app_tax_rules_updated_by_users_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "license_transaction_taxes" ADD CONSTRAINT "license_transaction_taxes_tax_rule_id_app_tax_rules_id_fk" FOREIGN KEY ("tax_rule_id") REFERENCES "public"."app_tax_rules"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
